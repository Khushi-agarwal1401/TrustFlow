  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="card p-8 w-full max-w-md">
        <h1 className="text-2xl font-bold text-center mb-2" style={{ fontFamily: "var(--font-poppins)" }}>
          Sign in to TrustFlow
        </h1>
        <p className="text-text-secondary text-center text-sm mb-6">
          AI-powered accountability for your freelance projects
        </p>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center"><span className="bg-bg-surface px-3 text-text-muted text-sm">or</span></div>
        </div>
