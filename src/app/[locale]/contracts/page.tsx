      ...
      <aside className="w-[260px] bg-white border-r border-gray-200 flex flex-col justify-between hidden lg:flex shrink-0 h-screen overflow-y-auto">
        <div>
          ...
          <nav className="px-4 py-6 flex flex-col gap-1">
            ...
            <Link href="/contracts" className="flex items-center gap-3 px-3 py-2.5 bg-[#EEF2FF] text-[#4F46E5] font-medium rounded-lg">
            ...
            {['Milestones', 'Escrow & Payments', 'Disputes', 'Messages', 'Analytics', 'Freelancers', 'Settings'].map(item => (
